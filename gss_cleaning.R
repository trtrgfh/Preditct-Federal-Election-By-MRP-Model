...
reduced_data <- 
  reduced_data %>%
  count(age, sex, province, education, marital_status) %>%
  group_by(age, sex, province, education, marital_status) 


reduced_data <- 
  reduced_data %>% mutate(educ = case_when(education == "Less than high school diploma or its equivalent" ~
                                           ...
                                           education == "College, CEGEP or other non-university certificate or di..." ~
                                             "College degree",
                                           education == "Trade certificate or diploma" ~ "College degree",
                                           education == "Bachelor's degree (e.g. B.A., B.Sc., LL.B.)" ~ "Bachelor's degree",
                                           education == "NA" ~ "No schooling"))
